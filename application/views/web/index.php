                    ...
                    <div class="container">
                        <div class="col-md-offset-4 col-sm-offset-4 col-md-4 col-sm-4">
                            <span class="service-divider wow fadeIn" data-wow-delay="200ms">
                                <img src="<?php echo base_url(); ?>web_assets/img/top-divider.png" class="img-responsive" alt="Image">
                            </span>
                            <span class="solution-we-pro wow fadeIn" data-wow-delay="300ms">Solutions we provide.</span>
        ...
        <!-- ARENA PROMOTIONS AREA START  -->

        <section class="arena-promotions-section">
            <div class="container-fluid padding0">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="special-promotions text-center wow fadeIn" data-wow-delay="400ms">
                        <h3><span>S</span>pecial <br> promotions</h3>
                        <a href="<?php echo base_url(); ?>home/promotions">view promos</a>
                    </div>
                </div>

            </div>
            <div class="brand-position wow fadeIn" data-wow-delay="200ms"><p>BRANDS WE WORK WITH</p></div>
        </section>

        <!-- ARENA PROMOTIONS AREA END  -->
        <section class="arena-brand-section wow fadeIn" data-wow-delay="300ms">
            <div class="container">
